window.addEventListener('load', function () {
    ...
    function getDateOfLastUpdate() {
       ...
       return $.ajax({
            url: $.Api.getRecentAttemptsDate(globalEventId),
            type: 'GET',
            dataType: 'json',
    ...
    function getUserAttemptData() {
        ...
        return $.ajax({
            url: $.Api.getRecentAttemptsByEvent(globalEventId), //TODO: the formEventId is hardcoded to 1 - WILL NEED to be changed based on the event selected
            type: 'GET',
            dataType: 'json',
    ...
    function clearTables() {
        var $recentScoresTable = $('.user-scores-target');
        ...
        $userStatsTable.fadeOut(fadeoutTime, function () {
            ...
            $userStatsTable.show();
            $recentScoresTable.show();
        });
    }

    function loadRecentScoresTable() {
        var markup = '';
